...
public class QuizTextToSpeech extends AppCompatActivity implements  View.OnClickListener {

    private  TextView tvQuesion;
    public   TextView tvContentQuesion;
    private  TextView tvAnser1,tvAnser2,tvAnser3,tvAnser4;
    private  Quesion mQuesion;
    private  List<Quesion> mListQuesion;//list quesions
    private  int currentQuesion=0;
    private  TextView npoint ;
    private  int mpoint=0;
    private  ImageView speach;
